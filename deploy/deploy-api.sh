...
ALLOWED_HOSTS="${ALLOWED_HOSTS:?set ALLOWED_HOSTS e.g. regwatch-api-xxxx.a.run.app}"
CSRF_ORIGINS="${CSRF_ORIGINS:?set CSRF_ORIGINS e.g. https://regwatch-api-xxxx.a.run.app}"
